<script type="text/javascript">
 ...
 {!! Form::open(['method'=>'POST','files'=>true, 'enctype' => 'multipart/form-data','id' => 'eidtproduct']) !!}
                            ...
                            <div class="content-item">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td> <select name="category_slug">
                                                  ...
                                                  @foreach ($datacat as $datas)
                                                <option value="{{$datas->categories_slug}}">{{$datas->categories_name}}</option>
                                                  @endforeach
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td> {!! Form::text('product_name',$data->product_name) !!}</td>
                                    </tr>
                                    <tr>
                                        <th>{!! Form::label('Nhập Giá Sản Phẩm') !!}</th>
                                        <td> {!! Form::text('product_price',$data->product_price) !!}</td>
                                    </tr>
                                    <tr>
                                        <th>{!! Form::label('Nhập material Sản Phẩm') !!}</th>
                                        <td> {!! Form::text('product_material',$data->product_material) !!}</td>
                                    </tr>
                                    <tr>
                                        <th>{!! Form::label('Nhập size Sản Phẩm') !!}</th>
                                        <td> {!! Form::text('product_size',$data->product_size) !!}</td>
                                    </tr>
                                ...
                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td> {!! Form::text('product_sizedetail',$data->product_sizedetail) !!}</td>
                                    </tr>
                                    <tr>
                                        <th>{!! Form::label('Nhập maker Sản Phẩm') !!}</th>
                                        <td> {!! Form::text('product_maker',$data->product_maker) !!}</td>
                                    </tr>
                                    <tr>
                                        <th>{!! Form::label('Nhập origin Sản Phẩm') !!}</th>
                                        <td> {!! Form::text('product_origin',$data->product_origin) !!}</td>
                                    </tr>
                                    <tr>
                                        <th>{!! Form::label('Nhập handing Sản Phẩm') !!}</th>
                                        <td> {!! Form::text('product_handing',$data->product_handing) !!}</td>
                                    </tr>
                                    <tr>
                                        <th>{!! Form::label('Nhập manufacturing Sản Phẩm') !!}</th>
                                        <td> {!! Form::text('product_manufacturing',$data->product_manufacturing) !!}</td>
                                    </tr>
                                    <tr>
                                        <th>{!! Form::label('Nhập srandarbs Sản Phẩm') !!}</th>
                                        <td> {!! Form::textarea('product_srandarbs',$data->product_srandarbs,['size' => '50x5']) !!}</td>
                                    </tr>
                                    <tr>
                                        <th>{!! Form::label('Nhập derector Sản Phẩm') !!}</th>
                                        <td> {!! Form::text('product_derector',$data->product_derector) !!}</td>
                                    </tr>
